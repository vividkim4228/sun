...
/*  
01. text()       : 작성한  내용을 확인 / 작성하는 메소드 
02. html()       : html태그를 확인 / 제작하는 메소드 
...
09. remove()     : 선택요소를 삭제하는 메소드
10. empty()      : 선택요소의 내부를 비우는 메소드
11. removeAttr() : 선택요소의 속성을 삭제하는 메소드
12. attr()       : 선택요소의 속성을 파악 / 수정 / 삽입하는 메소드
13. val()        : form요소의 값을 파악 / 삽입하는 메소드
*/
...
// jQuery에서는 a 를 li의 모든요소에서 찾아낸다.
// js에서는 li의 순서를 명확하게 인지한 후에 찾아내야 한다.
// 단, li의 명확한 순서에 맞는 자식 a 에게 기능을 부여하려면 li에서 정확하게 순서를 지칭해야한다.
...
// var wc = $('#headBox').children().attr('class');
// console.log(wc)
...
// $('a').css({color:'#fc0', fontSize:'1.3rem', margin:'0.5rem'});

$('#listBox').css({backgroundColor:'#fc0',width:'90%', margin:'auto'});


console.log(re_lsLista);


lsLista.find('li').removeAttr('class');
...
// shop.append(product);
// 복잡한기능까지 사용하려면 'true' 작성
// 필요한 갯수만큼 복제한 후 마지막자식은 지우기 
// var color =['#fc0','#cca','#acf','#f06','#f7f','#afa'];
// var link =['http://naver.com','http://daum.net','http://google.com','http://behance.com','http://pinterest.com','http://dribbble.com'];
// var text = ['제품1', 
// '제품2', 
//   '제품3', 
//     '제품4', 
...
var productList = [
  {color:'#fc0', text:'제품01', link:'http://naver.com'},
  {color:'#cca', text:'제품02', link:'http://daum.net'},
  {color:'#acf', text:'제품03', link:'http://google.com'},
  {color:'#f06', text:'제품04', link:'http://behance.com'},
  {color:'#f7f', text:'제품05', link:'http://pinterest.com'},
  {color:'#afa', text:'제품06', link:'http://dribbble.com'}
];
